                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane pad-btm fade in active" id="demo-bsc-tab-1">
                                            ...
                                            <div class=" form-group">
                                                    ...
                                                    <?= $form->field($model, 'category_id')->dropDownList((new app\models\Categories())->arrAll())->label('Category') ?>

                                                    <?= $form->field($model, 'status')->dropDownList(app\helpers\MyDefine::arrStatus(true)) ?>                               

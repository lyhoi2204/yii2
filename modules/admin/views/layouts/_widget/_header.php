						...
						<li class="dropdown">
							<a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
								<span class="lang-selected">
									<img class="lang-flag" src="/admin/img/flags/united-kingdom.png" alt="English">
							...
							<ul class="head-list dropdown-menu with-arrow">
								...
								<li>
									<!--France-->
									<a href="#">
										<img class="lang-flag" src="/admin/img/flags/france.png" alt="France">
								...
								<li>
									<!--Germany-->
									<a href="#">
										<img class="lang-flag" src="/admin/img/flags/germany.png" alt="Germany">
								...
								<li>
									<!--Italy-->
									<a href="#">
										<img class="lang-flag" src="/admin/img/flags/italy.png" alt="Italy">
								...
								<li>
									<!--Spain-->
									<a href="#">
										<img class="lang-flag" src="/admin/img/flags/spain.png" alt="Spain">
